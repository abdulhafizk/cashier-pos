      ...
      <tr key={obj.id} className={`group hover:text-accent cursor-pointer`}>
        ...
        <td>
          <div className="flex">
            <button
              onClick={() =>
                confirm("Delete history?", () => deleteHistory(obj.id))
              }
            ...
            >
              ...
              <div className="flex justify-between">
                <b className="card-title">
                  Total {numeral(item.qtys).format("0,0")} item
                </b>
                <b className="card-title">
              ...
              <div className="flex opacity-50">
                ...
                <b className="text-sm ml-auto">
                  {item.cash ? numeral(item.cash).format("0,0") : "-"}
                </b>
              </div>
              <div className="flex opacity-50 mb-4">
                ...
                <b className="text-sm ml-auto">
                  {item.cash
                    ? numeral(
                        parseInt(item.cash) - parseInt(item.totals)
                      ).format("0,0")
                    : "-"}
                </b>
              </div>
