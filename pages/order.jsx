              ...
              <div className="card bg-base-300 w-72 text-base-content shadow-xl">
                ...
                >
                  ...
                  {orders.items.length > 0 ? (
                    ...
                    <b className="text-base-content opacity-40">No Item</b>
                  )}
                  ...
                  <div className="flex justify-between">
                    <b className="card-title">
                      Total {numeral(orders.qtys).format("0,0")} item
                    </b>
                    <b className="card-title">
                      {numeral(orders.totals).format("0,0")}
                    </b>
                  </div>
                  ...
                  <div className="flex opacity-50">
                    ...
                    <b className="text-sm ml-auto">
                      {orders.cash ? numeral(orders.cash).format("0,0") : "-"}
                    </b>
                  </div>
                  <div className="flex opacity-50 mb-4">
                    ...
                    <b className="text-sm ml-auto">
                      {orders.cash
                        ? numeral(
                            parseInt(orders.cash) - parseInt(orders.totals)
                          ).format("0,0")
                        : "-"}
                    </b>
                  </div>
                  ...
                  <div className="flex flex-col">
                    <form onSubmit={(event) => submitHistory(event)}>
                      ...
                      <div className="flex justify-between mr-1">
                        <div
                          className={`btn ${
                            orders.qtys <= 0 ? "btn-disabled" : "btn-ghost"
                          } w-1/2 btn-md mr-1`}
                          onClick={() => setOrders(initialOrder)}
                        >
                          Clear
                        </div>
                        <button
